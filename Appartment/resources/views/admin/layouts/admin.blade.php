            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="admin-dashboard.html" class="app-brand-link">
                        <span class="app-brand-text demo menu-text fw-bold">Admin Page </span>
                    </a>
                </div>
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <p class="mb-0">Selamat Datang <span class="fw-bolder text-primary">Admin</span></p>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <span
                                                            class="avatar-initial rounded-circle bg-label-primary">Admin</span>
                                                    </div>
                                                </div>
