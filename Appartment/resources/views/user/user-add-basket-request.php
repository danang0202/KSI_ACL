...
<head>
    ...
    <title>ApartementFacility  - Basket Field Request</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Requests/</span> Ajukan Basket Field Requests
                        </h4>
                        <!-- Default -->
                        <div class="row">
                            <div class="col-12">
                                            ...
                                            <div id="personal-info" class="content">
                                                <div class="row g-3">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" id="first-name" class="form-control" value="Basket Field" readonly />
                                                    </div>                                                    
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label for="bentukRequest" class="form-label">Additional Add
                                                            </label>
                                                        <select id="bentukRequest" class="selectpicker w-auto"
                                                            data-style="btn-default">
