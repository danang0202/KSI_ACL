...
<html class="no-js" lang="en">
  ...
  <body id="top">
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="../../images/hero-bg2.png" data-natural-width="3000" data-natural-height="2000" data-position-y="center">
      ...
      <div class="home-content">
        <div class="row home-content__main">
          ...
          <div class="home-content__buttons">
            <a href="user-login.html" class="btn btn--stroke"> Mulai Request </a>
            <a href="#about" class="smoothscroll btn btn--stroke"> Tentang Kami </a>
          </div>
        </div>
    ...
    <section id="about" class="s-about">
      ...
      <div class="row about-desc" data-aos="fade-up" style="color: white">
        <div class="col-full">
          <p>
            UKM Media Kampus adalah wadah komunikasi dan kreativitas yang berkedudukan di Politeknik Statistika STIS, berperan penting dalam menjalankan fungsi jurnalistik untuk dokumentasi dan publikasi berbagai kegiatan internal maupun
            eksternal yang terkait dengan institusi. Sebagai salah satu pilar penting dalam komunikasi dan informasi, UKM Media Kampus juga mengemban peran sebagai Humas Politeknik STIS, memastikan terjalinnya komunikasi yang baik antara
            institusi dengan pihak-pihak terkait.
          </p>
        </div>
      </div>
      <!-- end about-desc -->
      ...
      <div class="row services-list block-1-2 block-tab-full">
        <div class="col-block service-item" data-aos="fade-up">
          ...
          <div class="service-text">
            ...
            <p>
              Bertugas memberitakan suatu peristiwa dengan cara mengabadikannya dalam bentuk foto. Foto-foto tersebut menyampaikan informasi berupa gambar kepada khalayak tanpa proses pengeditan yang berlebihan dengan tujuan tetap menjaga
              fakta yang terkandung pada foto-foto tersebut.
            </p>
          </div>
        </div>
        ...
        <div class="col-block service-item" data-aos="fade-up">
          ...
          <div class="service-text">
            ...
            <p>
              Memiliki tugas utama meliput, mengolah, dan menyajikan informasi dalam bentuk artikel kepada khalayak. Poin-poin penting peristiwa mengenai apa, siapa, di mana, kapan, mengapa, dan bagaimana (5W+1H) merupakan hal-hal yang
              dibahas dalam pemberitaanya. Tidak hanya artikel, tetapi divisi ini kerap menghasilkan karya sastra, seperti puisi dan cerita pendek.
            </p>
          </div>
        </div>
        ...
        <div class="col-block service-item" data-aos="fade-up">
          ...
          <div class="service-text">
            ...
            <p>
              Menggunakan gambar untuk menyampaikan informasi atau pesan seefektif mungkin. Divisi ini bertugas mendesain publikasi yang rapi dan menarik, sehingga publik lebih tertarik untuk mengetahui suatu informasi. Divisi desain grafis
              berperan aktif dalam mendesain tata letak (layout) dalam suatu publik.
            </p>
          </div>
        </div>
        ...
        <div class="col-block service-item" data-aos="fade-up">
          ...
          <div class="service-text">
            ...
            <p>
              Bergerak dalam bidang pembuatan video. Video ialah teknologi pengiriman sinyal elektronik dari suatu gambar bergerak. Aplikasi umum dari sinyal video adalah televisi, tetapi dapat juga digunakan dalam aplikasi lain di dalam
              bidang teknik, scientific, produksi, dan keamanan.
            </p>
          </div>
        </div>
    ...
    <footer>
      <div class="row footer-main">
        <div class="col-six tab-full left footer-desc">
          ...
          Penjelasan tentang SIREMA
        </div>

        <div class="col-six tab-full right footer-subscribe">
          <h4>Get Notified</h4>
          <p>
            Dapatkan Pemberitahuan Terbaru di Sirema! Dapatkan informasi terkini tentang project yang kami lakukan. Jadilah yang pertama tahu dan jangan lewatkan perkembangan terbaru. Bergabunglah dengan komunitas kami untuk mendapatkan
            aliran informasi yang lancar, tepat di ujung jari Anda.
          </p>
